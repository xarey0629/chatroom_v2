...
const checkOutChatBox = async(name1, name2) => {
  let chatBoxName = [name1, name2].sort().join('_');
  ...
  console.log('Validation of chat box:', (box));
  return box;
}
...
const Mutation = {
  ...
  //   const emailTaken = db.users.some((user) => user.email === args.data.email); // args.data -> data: createUser(data:{...})
  //   if (emailTaken) {
